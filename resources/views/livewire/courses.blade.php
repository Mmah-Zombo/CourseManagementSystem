                ...
                <div class="col-span-full">
                  <div class="w-full h-full flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
                    <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
                        ...
                        <p class="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">There are no courses available at the moment! Please check back in a month's time.</p>
                        <a href="/dashboard" class="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 rounded transition duration-150" title="Return Home">
