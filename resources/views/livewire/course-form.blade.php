            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border-y-2 border-blue-600">
                <form action="{{ route('createCourse')}}" method="POST" class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        ...
                        <button type="submit" class="rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Create Course</button>
                    </div>
                </form>
            </div>
        </div>
