<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
              <p class="text-2xl font-bold">Courses You Are Enrolled In</p>
            </div>
            <div class="grid grid-cols-4 grid-flow-col gap-4">
              @if(isset($myCourses) && count($myCourses) > 0)
                @foreach ($myCourses as $course)
                  
                  <div class="max-w-xs flex flex-col bg-white border border-t-4 border-t-green-300 shadow-sm hover:shadow-xl rounded-xl transition-all duration-500">
                    <div class="p-4 md:p-5">
                      ...
                      <a href="/course/{{ $course->id }} "class="mt-3 inline-flex items-center gap-x-1 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none" href="#">
                        More Info
                  ...
                  <div class="col-span-full">
                    <div class="w-full h-full flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
                      <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
                          <p class="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-gray-300">000</p>
                          <p class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-gray-300 mt-2">NO COURSE FOUND</p>
                          <p class="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">You have not enrolled for any course yet.</p>
                          <a href="/courses" class="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 rounded transition duration-150" title="Return Home">
